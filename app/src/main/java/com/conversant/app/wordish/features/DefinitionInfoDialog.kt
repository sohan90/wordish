...
class DefinitionInfoDialog : DialogFragment() {
    ...
    private fun observeSelectedWord() {
        gameViewModel.selectedWord.observe(this, {
    ...
    private fun searchMeaningForWord(selectedWord: String) {
        disposable = wordDataSource.getMeaningForWord(selectedWord)
            .subscribeOn(Schedulers.io())
            .observeOn(AndroidSchedulers.mainThread())
            .subscribe { word, _ ->
                showWebView(selectedWord, word)
            }
    }
